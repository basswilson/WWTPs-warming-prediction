...
Modified on Mar 16 2025 for denormalized plotting (merged all columns into one plot)
...
class MyDataset(Dataset):
    def __init__(self, col=1):
        data1 = np.loadtxt('/home/hongchang/Documents/WS-Pytorch/WWTPs_Tem_DIS_(Final)/污水厂数据集/4.csv',
...
for col in range(1, 1626):  # 你可以根据需要调整列范围
    ...
    results_dir = '/home/hongchang/Documents/WS-Pytorch/WWTPs_Tem_DIS_(Final)/results/Before Perturbed/alpha/analysis/individual_cols/'
