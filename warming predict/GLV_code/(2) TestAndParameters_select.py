...
np.savetxt('/home/hongchang/Documents/WS-Pytorch/WWTPs_Tem_DIS_(Final)/results/Before Perturbed/GLV/analysis/' + 'Test_Before.txt',
           Test_result, fmt='%.4e', delimiter='\t', newline='\n')
np.savetxt(
    '/home/hongchang/Documents/WS-Pytorch/WWTPs_Tem_DIS_(Final)/results/Before Perturbed/GLV/analysis/' + 'Test_and_parameters_Before.csv',
