...
def k_fold(infor_file, k, mydata, seed, drop, num_epochs = 100, batch_size = 78, learning_rate = 0.00001, weight_decay=0):
    ...
    for i in range(k):
        ...
        model = Neural3network(8, 17, 1, drop)
...
os.chdir('/home/hongchang/Documents/WS-Pytorch/WWTPs_Tem_DIS_(Final)/Before Perturbed/results/GLV/') #change direction.
