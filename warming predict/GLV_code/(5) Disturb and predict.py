...
np.savetxt('/home/hongchang/Documents/WS-Pytorch/WWTPs_Tem_DIS_(Final)/results/After Perturbed/GLV/analysis/' + 'Test_After.txt',
           Test_result, fmt='%.4e', delimiter='\t', newline='\n')
np.savetxt(
    '/home/hongchang/Documents/WS-Pytorch/WWTPs_Tem_DIS_(Final)/results/After Perturbed/GLV/analysis/' + 'Test_and_parameters_After.csv',
